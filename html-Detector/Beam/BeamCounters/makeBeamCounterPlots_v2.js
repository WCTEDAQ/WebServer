...
//var plots=["primary","level2","level1_0","level1_1","t0_counts","t1_counts","eveto_acts","mupi_acts","others","tof_0","tof_1"];
var plots=["primary"];
...
function Init(){
	...
	plotTraces.set('primary',['TDCT00','XTRIG','LASER','T3']);
	//plotTraces.set('level2',['LE psV','LE TOF','LE e','LE mu']);
	//plotTraces.set('level1_0',['T0 L1','T1 L1','T0T1L1','TOFR','TOFL']);
	//plotTraces.set('level1_1',['HC L1','MUON','ACTeOR','ACT0Rps','ACT0lps']);
	//plotTraces.set('t0_counts',['T0-0L','T0-0R','T0-1L','T0-1R']);
	//plotTraces.set('t1_counts',['T1-0L','T1-0R','T1-1L','T1-1R']);
	//plotTraces.set('eveto_acts',['ACT0-L','ACT0-R','ACT1-L','ACT1-R','ACT2-L','ACT2-R']);
	//plotTraces.set('mupi_acts',['ACT3-L','ACT3-R','ACT4-L','ACT4-R','ACT5-L','ACT5-R']);
	//plotTraces.set('others',['T4-L','T4-R','HC-0','HC-1','MuT-L','MuT-R','PbG']);
	...
	//plotTypes.set('level1_0','TS');
	//plotTypes.set('level1_1','TS');
	//plotTypes.set('t0_counts','TS'); 
	//plotTypes.set('t1_counts','TS');
	//plotTypes.set('eveto_acts','TS');
	//plotTypes.set('mupi_acts','TS');
	//plotTypes.set('others','TS');
	...
	//plotNames.set('level1_0','Level 1 Outputs, Group 1');
	//plotNames.set('level1_1','Level 1 Outputs, Group 2');
	//plotNames.set('t0_counts','T0 Counts'); 
	//plotNames.set('t1_counts','T1 Counts');
	//plotNames.set('eveto_acts','Electron Veto ACT Counts');
	//plotNames.set('mupi_acts','Mu/Pi Separation ACT Counts');
